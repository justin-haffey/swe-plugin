...
> **Scope selector:** [ ] Module  [x] Package  [ ] Solution  
> **Document status:** `<Draft | Proposed | Accepted | Superseded>`  
> **Owner:** `<team / architect / maintainer>`  
> **Version:** `<document version>`  
> **Last updated:** `<YYYY-MM-DD>`  
> **Source scope:** `<repository path / project / package>`  
> **Package identity:** `<package name / package ID>`  
> **Distribution:** `<NuGet | npm | Maven | PyPI | internal artifact | source-only | other>`
