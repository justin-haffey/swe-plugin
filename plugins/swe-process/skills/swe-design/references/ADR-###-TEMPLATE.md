...
Date: YYYY-MM-DD
Related Features: `.swe/04-FEATURE/...` (recommended)
Supersedes: `.swe/02-ADR/ADR-....md` (delete if none)
Superseded by: `.swe/02-ADR/ADR-....md` (delete if none)
...
- Once accepted, save as `.swe/DR/ADR-XXXX-title-in-kebab-case.md` (English, kebab-case). Keep `.codex/swe/templates/ADR-###-TEMPLATE.md` unchanged.
...
- [ ] File saved under `.swe/02-ADR/ADR-###-TITLE.md`.
...
- [ ] `.swe/01-DESIGN/DESIGN.md` updated if module boundaries or interactions changed.
