...
title: "Specification-Driven Agent Development - Awesome Agentic Patterns"
---

[Skip to content](https://agentic-patterns.com/patterns/specification-driven-agent-development/#problem)
...
Adopt a **spec-first workflow** in which a formal specification file (e.g., Markdown, OpenAPI, JSON Schema) is the agent's _primary_ input and source of truth.
...
- **Iterate** only by editing the spec, _not_ by re-prompting ad-hoc.
