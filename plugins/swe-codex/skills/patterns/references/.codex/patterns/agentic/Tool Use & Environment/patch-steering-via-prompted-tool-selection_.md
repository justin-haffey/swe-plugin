...
title: "Patch Steering via Prompted Tool Selection - Awesome Agentic Patterns"
---

[Skip to content](https://agentic-patterns.com/patterns/patch-steering-via-prompted-tool-selection/#problem)
...
\- The agent recognizes "apply\_patch" as the preferred patching mechanism.
...
- **Fallback Handling:** If the agent ignores the instruction and uses the wrong tool, include a directive: "If ASTRefactor fails, fallback to apply\_patch."
