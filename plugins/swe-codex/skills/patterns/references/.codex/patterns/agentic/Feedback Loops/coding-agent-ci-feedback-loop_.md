...
title: "Coding Agent CI Feedback Loop - Awesome Agentic Patterns"
---

[Skip to content](https://agentic-patterns.com/patterns/coding-agent-ci-feedback-loop/#problem)
...
UserFilesCIGitRepoAgentUserFilesCIGitRepoAgentloop\[every 30s\]create branch coding-agent-refactortrigger tests remotelypartial failures or success chunkpatch specific failuresre-run only failing tests✅ all tests green"PR is ready to merge"
