...
title: "CLI-Native Agent Orchestration - Awesome Agentic Patterns"
---

[Skip to content](https://agentic-patterns.com/patterns/cli-native-agent-orchestration/#problem)
...
Expose agent capabilities through a **first-class command-line interface** (here: _Claude CLI_).
