...
title: "Continuous Autonomous Task Loop Pattern - Awesome Agentic Patterns"
---

[Skip to content](https://agentic-patterns.com/patterns/continuous-autonomous-task-loop-pattern/#problem)

# Continuous Autonomous Task Loop Pattern NEW
...
File SystemGit Master SubagentMain AgentTask Master SubagentAutonomous ScriptFile SystemGit Master SubagentMain AgentTask Master SubagentAutonomous Script--dangerously-skip-permissionsFresh context, focused executionIntelligent delay before retryalt\[Rate Limit Detected\]Continue to next iterationloop\[Continuous Task Processing\]Select next task from TODO.md"Implement user authentication"Execute task autonomouslyImplement code changesTask completed successfullyCommit changesgit add, commit with messageChanges committedExponential backoff waitUpdate progress counters
