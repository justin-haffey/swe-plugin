...
title: "Inference-Healed Code Review Reward - Awesome Agentic Patterns"
---

[Skip to content](https://agentic-patterns.com/patterns/inference-healed-code-review-reward/#problem)
...
- **Human-in-the-Loop Checkpoints:** If a patch is borderline (e.g., final\_score ∈ \[0.5, 0.7\]), route it for manual code review to generate better labels for future training.

## Trade-offs

- **Pros:**
- **Explainable Feedback:** The agent knows _why_ a patch scored poorly, allowing targeted improvements.
