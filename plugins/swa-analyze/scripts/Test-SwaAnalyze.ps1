...
$portfolioAllocations = [ordered]@{
    ...
    'swe\platform-engineer.toml' = @('$swe-new-epic', '$swe-plan-features', '$swe-plan-implementation', '$swe-validate', '$swa-analyze')
    ...
    'swe\architecture-reviewer.toml' = @('$swe-validate') + $allSwaSkills
    'swe\integration-engineer.toml' = @('$swe-design', '$swe-implement', '$swe-validate', '$swa-analyze', '$swa-boundary', '$swa-interface', '$swa-scenario')
}
$solutionDelivery = @('$swe-design', '$swe-implement', '$swe-validate', '$swe-bugfix', '$swe-enhancement')
$solutionAllocations = [ordered]@{
    ...
    'swe\architecture-reviewer.toml' = @('$swe-validate')
