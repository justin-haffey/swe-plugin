---
name: swa-constraint
description: Classify architectural constraints, temporarily remove or relax negotiable ones, and selectively reintroduce them to discover better software designs. Use when limitations appear absolute but may be inherited, local, or negotiable. Do not bypass real policy or modify the system.
---

# Constraint Reframing

Distinguish hard constraints from assumed ones so the architecture can be evaluated against a less restricted ideal and then made practical.
