---
name: swa-boundary
description: Critique the inclusion, exclusion, ownership, and responsibility boundaries of an existing software architecture and recommend better boundaries. Use when scope leakage, misplaced ownership, excluded concerns, or repository seams constrain the design. Do not modify architecture or code.
---

# Boundary Critique

Expose how the current framing includes, excludes, or marginalizes responsibilities and then propose more coherent boundaries.
