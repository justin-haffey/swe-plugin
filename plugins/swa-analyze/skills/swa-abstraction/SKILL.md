---
name: swa-abstraction
description: Move up and down abstraction levels in existing software artifacts to expose mixed concerns, missing principles, and cleaner design implications. Use when architecture is cluttered with mechanics or high-level intent fails to constrain lower-level design. Do not edit the analyzed artifacts.
---
