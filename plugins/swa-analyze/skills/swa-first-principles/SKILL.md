---
name: swa-first-principles
description: Decompose an existing software architecture into verified outcomes, invariants, and hard constraints, then reconstruct a cleaner conceptual design. Use when inherited assumptions dominate and incremental improvement is unlikely to meet the intended outcomes. Do not implement or alter the proposed reconstruction.
---

# First-Principles Reconstruction

Separate fundamental truths from inherited choices and build a coherent alternative from the smallest defensible set of premises.
