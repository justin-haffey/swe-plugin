...
> **Scope selector:** [ ] Module  [ ] Package  [x] Solution  
> **Document status:** `<Draft | Proposed | Accepted | Superseded>`  
> **Owner:** `<solution architect / architecture owner / team>`  
> **Version:** `<document version>`  
> **Last updated:** `<YYYY-MM-DD>`  
> **Solution scope:** `<repository group / product / platform / program>`  
> **Business owner:** `<product/business owner>`  
> **Technical owner:** `<engineering/platform owner>`
